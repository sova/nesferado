...
var args30248 = [];
var len__9664__auto___30252 = arguments.length;
var i__9665__auto___30253 = (0);
while(true){
if((i__9665__auto___30253 < len__9664__auto___30252)){
args30248.push((arguments[i__9665__auto___30253]));

var G__30254 = (i__9665__auto___30253 + (1));
i__9665__auto___30253 = G__30254;
continue;
} else {
}
break;
...
var G__30251 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__30251,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__30251;
}
});
...
var or__8593__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__9664__auto___30259 = arguments.length;
var i__9665__auto___30260 = (0);
while(true){
if((i__9665__auto___30260 < len__9664__auto___30259)){
args__9671__auto__.push((arguments[i__9665__auto___30260]));

var G__30261 = (i__9665__auto___30260 + (1));
i__9665__auto___30260 = G__30261;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__9672__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq30256){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__30257,G__30258,seq30256__$2);
});
...
var file = cljs.core.get.call(null,map__30265__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__30265__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__30265__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__30265,map__30265__$1,file,line,column){
return (function (p1__30262_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__30262_SHARP_));
});})(map__30265,map__30265__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__9518__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__9518__auto__,prefer_table__9519__auto__,method_cache__9520__auto__,cached_hierarchy__9521__auto__,hierarchy__9522__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__8593__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__8593__auto__)){
return or__8593__auto__;
} else {
...
var temp__4657__auto___30267 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___30267)){
var message_30268 = temp__4657__auto___30267;
cljs.core.println.call(null,message_30268);
} else {
}
...
var temp__4657__auto___30269 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___30269)){
var message_30270 = temp__4657__auto___30269;
cljs.core.println.call(null,message_30270);
} else {
}
...
var temp__4655__auto__ = (function (){var and__8581__auto__ = typeof exception.stack === 'string';
if(and__8581__auto__){
var G__30280 = exception.stack;
var G__30280__$1 = (((G__30280 == null))?null:clojure.string.split_lines.call(null,G__30280));
var G__30280__$2 = (((G__30280__$1 == null))?null:cljs.core.get.call(null,G__30280__$1,depth));
if((G__30280__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__30280__$2);
}
} else {
...
var vec__30281 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__30281,(0),null);
var column = cljs.core.nth.call(null,vec__30281,(1),null);
var vec__30284 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__30284,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__30284,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__30284,(2),null);
...
var m__$1 = (function (){var G__30288 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__30288) {
case "fail":
...
var G__30294 = (function (){var G__30293 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__30293);
} else {
return G__30293;
}
})();
...
return cljs.core.vary_meta.call(null,G__30296,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e30299){var e = e30299;
var G__30300 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__30300) {
...
var vec__30305 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__30305,(0),null);
var types = vec__30305;
...
return cljs.core.map.call(null,(function (p__30317){
var vec__30318 = p__30317;
var ns = cljs.core.nth.call(null,vec__30318,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__30318,(1),null);
return ((function (vec__30318,ns,vars__$1){
return (function (){
...
var G__30321 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__30321) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__30321,env,once_fixtures,each_fixtures,vec__30318,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__30321,env,once_fixtures,each_fixtures,vec__30318,ns,vars__$1){
return (function (){
var seq__30322 = cljs.core.seq.call(null,vars__$1);
var chunk__30323 = null;
var count__30324 = (0);
var i__30325 = (0);
while(true){
if((i__30325 < count__30324)){
var v = cljs.core._nth.call(null,chunk__30323,i__30325);
var temp__4657__auto___30327 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___30327)){
var t_30328 = temp__4657__auto___30327;
each_fixture_fn.call(null,((function (seq__30322,chunk__30323,count__30324,i__30325,t_30328,temp__4657__auto___30327,v,each_fixture_fn,G__30321,env,once_fixtures,each_fixtures,vec__30318,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_30328)));
});})(seq__30322,chunk__30323,count__30324,i__30325,t_30328,temp__4657__auto___30327,v,each_fixture_fn,G__30321,env,once_fixtures,each_fixtures,vec__30318,ns,vars__$1))
);
} else {
}
...
var temp__4657__auto__ = cljs.core.seq.call(null,seq__30322);
if(temp__4657__auto__){
var seq__30322__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__30322__$1)){
var c__9404__auto__ = cljs.core.chunk_first.call(null,seq__30322__$1);
var G__30333 = cljs.core.chunk_rest.call(null,seq__30322__$1);
var G__30334 = c__9404__auto__;
var G__30335 = cljs.core.count.call(null,c__9404__auto__);
var G__30336 = (0);
seq__30322 = G__30333;
...
var v = cljs.core.first.call(null,seq__30322__$1);
var temp__4657__auto___30337__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___30337__$1)){
var t_30338 = temp__4657__auto___30337__$1;
each_fixture_fn.call(null,((function (seq__30322,chunk__30323,count__30324,i__30325,t_30338,temp__4657__auto___30337__$1,v,seq__30322__$1,temp__4657__auto__,each_fixture_fn,G__30321,env,once_fixtures,each_fixtures,vec__30318,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_30338)));
});})(seq__30322,chunk__30323,count__30324,i__30325,t_30338,temp__4657__auto___30337__$1,v,seq__30322__$1,temp__4657__auto__,each_fixture_fn,G__30321,env,once_fixtures,each_fixtures,vec__30318,ns,vars__$1))
);
} else {
}

var G__30339 = cljs.core.next.call(null,seq__30322__$1);
var G__30340 = null;
var G__30341 = (0);
var G__30342 = (0);
seq__30322 = G__30339;
chunk__30323 = G__30340;
count__30324 = G__30341;
i__30325 = G__30342;
continue;
}
} else {
...
});})(each_fixture_fn,G__30321,env,once_fixtures,each_fixtures,vec__30318,ns,vars__$1))
);
});})(each_fixture_fn,G__30321,env,once_fixtures,each_fixtures,vec__30318,ns,vars__$1))
], null);
