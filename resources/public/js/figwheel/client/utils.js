...
var or__25785__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj34556 = {"detail":data};
return obj34556;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__25773__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__25773__auto__)){
var and__25773__auto____$1 = goog.object.get(window,"CustomEvent");
...
var args34561 = [];
var len__26860__auto___34567 = arguments.length;
var i__26861__auto___34568 = (0);
while(true){
if((i__26861__auto___34568 < len__26860__auto___34567)){
args34561.push((arguments[i__26861__auto___34568]));

var G__34569 = (i__26861__auto___34568 + (1));
i__26861__auto___34568 = G__34569;
continue;
} else {
}
break;
...
var f = (function (){var pred__34564 = cljs.core._EQ_;
var expr__34565 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34564.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34565))){
return ((function (pred__34564,expr__34565){
return (function (p1__34557_SHARP_){
return console.warn(p1__34557_SHARP_);
});
;})(pred__34564,expr__34565))
} else {
if(cljs.core.truth_(pred__34564.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34565))){
return ((function (pred__34564,expr__34565){
return (function (p1__34558_SHARP_){
return console.debug(p1__34558_SHARP_);
});
;})(pred__34564,expr__34565))
} else {
if(cljs.core.truth_(pred__34564.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34565))){
return ((function (pred__34564,expr__34565){
return (function (p1__34559_SHARP_){
return console.error(p1__34559_SHARP_);
});
;})(pred__34564,expr__34565))
} else {
return ((function (pred__34564,expr__34565){
return (function (p1__34560_SHARP_){
return console.log(p1__34560_SHARP_);
});
;})(pred__34564,expr__34565))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34571){
var map__34574 = p__34571;
var map__34574__$1 = ((((!((map__34574 == null)))?((((map__34574.cljs$lang$protocol_mask$partition0$ & (64))) || (map__34574.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34574):map__34574);
var opts = map__34574__$1;
var eval_fn = cljs.core.get.call(null,map__34574__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34576_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__34578,(0),null);
var v = cljs.core.nth.call(null,vec__34578,(1),null);
...
var args34581 = [];
var len__26860__auto___34585 = arguments.length;
var i__26861__auto___34586 = (0);
while(true){
if((i__26861__auto___34586 < len__26860__auto___34585)){
args34581.push((arguments[i__26861__auto___34586]));

var G__34587 = (i__26861__auto___34586 + (1));
i__26861__auto___34586 = G__34587;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var and__25773__auto__ = (typeof localStorage !== 'undefined') && (typeof goog.object.get(localStorage,"getItem") !== 'undefined');
...
//# sourceMappingURL=utils.js.map?rel=1543549047975