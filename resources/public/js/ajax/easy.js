...
var args22527 = [];
var len__7454__auto___22530 = arguments.length;
var i__7455__auto___22531 = (0);
while(true){
if((i__7455__auto___22531 < len__7454__auto___22530)){
args22527.push((arguments[i__7455__auto___22531]));

var G__22532 = (i__7455__auto___22531 + (1));
i__7455__auto___22531 = G__22532;
continue;
} else {
}
break;
...
var G__22535 = (((format instanceof cljs.core.Keyword))?format.fqn:null);
switch (G__22535) {
case "transit":
return ajax.transit.transit_request_format.call(null,format_params);
...
var G__22538 = (((format instanceof cljs.core.Keyword))?format.fqn:null);
switch (G__22538) {
case "transit":
...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__22540_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__22540_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__22541){
var map__22551 = p__22541;
...
var handler = cljs.core.get.call(null,map__22551__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__22551__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__22551__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return ((function (h,e,map__22551,map__22551__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__22553){
var vec__22557 = p__22553;
var ok = cljs.core.nth.call(null,vec__22557,(0),null);
var result = cljs.core.nth.call(null,vec__22557,(1),null);
...
;})(h,e,map__22551,map__22551__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__22560){
var map__22563 = p__22560;
...
var opts = map__22563__$1;
var method = cljs.core.get.call(null,map__22563__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__22563__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__22563__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__22563__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__22563__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
