...
var args22507 = [];
var len__7454__auto___22510 = arguments.length;
var i__7455__auto___22511 = (0);
while(true){
if((i__7455__auto___22511 < len__7454__auto___22510)){
args22507.push((arguments[i__7455__auto___22511]));

var G__22512 = (i__7455__auto___22511 + (1));
i__7455__auto___22511 = G__22512;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args22507.length)].join('')));
...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__22514){
var map__22517 = p__22514;
...
var handler = cljs.core.get.call(null,map__22517__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__6383__auto__ = p1__22519_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__22520){
var map__22523 = p__22520;
var map__22523__$1 = ((((!((map__22523 == null)))?((((map__22523.cljs$lang$protocol_mask$partition0$ & (64))) || (map__22523.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22523):map__22523);
var request = map__22523__$1;
var interceptors = cljs.core.get.call(null,map__22523__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__6383__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__6383__auto__)){
return or__6383__auto__;
} else {
