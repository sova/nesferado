...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__25980){
var vec__25981 = p__25980;
var _ = cljs.core.nth.call(null,vec__25981,(0),null);
var v = cljs.core.nth.call(null,vec__25981,(1),null);
...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__25984_SHARP_){
return ((p1__25984_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__25984_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__25986,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__25986;
}
});
...
var len__9664__auto___25989 = arguments.length;
var i__9665__auto___25990 = (0);
while(true){
if((i__9665__auto___25990 < len__9664__auto___25989)){
args__9671__auto__.push((arguments[i__9665__auto___25990]));

var G__25991 = (i__9665__auto___25990 + (1));
i__9665__auto___25990 = G__25991;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__9672__auto__);
});
...
var G__25988 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__25988,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__25988;
}
} else {
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq25987){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25987));
});
...
var vec__25997 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__25997,(0),null);
var names = cljs.core.nth.call(null,vec__25997,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__25997,tag_name,names){
return (function (p1__25992_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__25992_SHARP_))){
return p1__25992_SHARP_;
} else {
return null;
}
});})(matches,vec__25997,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__25997,tag_name,names){
return (function (p1__25993_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__25993_SHARP_));
});})(matches,vec__25997,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__26000){
var vec__26007 = p__26000;
...
var tag = first__26009;
var content = seq__26008__$1;
...
var vec__26010 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__26010,(0),null);
var id = cljs.core.nth.call(null,vec__26010,(1),null);
var class$ = cljs.core.nth.call(null,vec__26010,(2),null);
