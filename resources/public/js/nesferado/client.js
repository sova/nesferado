...
var len__9668__auto___31044 = arguments.length;
var i__9669__auto___31045 = (0);
while(true){
if((i__9669__auto___31045 < len__9668__auto___31044)){
args__9675__auto__.push((arguments[i__9669__auto___31045]));

var G__31046 = (i__9669__auto___31045 + (1));
i__9669__auto___31045 = G__31046;
continue;
} else {
}
break;
...
nesferado.client.__GT_output_BANG_.cljs$lang$applyTo = (function (seq31042){
var G__31043 = cljs.core.first.call(null,seq31042);
var seq31042__$1 = cljs.core.next.call(null,seq31042);
return nesferado.client.__GT_output_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__31043,seq31042__$1);
});

nesferado.client.__GT_output_BANG_.call(null," \u2022 Welcome to Nonforum \u2022");
var rand_chsk_type_31049 = (((cljs.core.rand.call(null) >= 0.5))?new cljs.core.Keyword(null,"ajax","ajax",814345549):new cljs.core.Keyword(null,"auto","auto",-566279492));
var packer_31050 = new cljs.core.Keyword(null,"edn","edn",1317840885);
var map__31047_31051 = taoensso.sente.make_channel_socket_client_BANG_.call(null,"/chsk",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),rand_chsk_type_31049,new cljs.core.Keyword(null,"packer","packer",66077544),packer_31050], null));
var map__31047_31052__$1 = ((((!((map__31047_31051 == null)))?((((map__31047_31051.cljs$lang$protocol_mask$partition0$ & (64))) || (map__31047_31051.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__31047_31051):map__31047_31051);
var chsk_31053 = cljs.core.get.call(null,map__31047_31052__$1,new cljs.core.Keyword(null,"chsk","chsk",-863703081));
var ch_recv_31054 = cljs.core.get.call(null,map__31047_31052__$1,new cljs.core.Keyword(null,"ch-recv","ch-recv",-990916861));
var send_fn_31055 = cljs.core.get.call(null,map__31047_31052__$1,new cljs.core.Keyword(null,"send-fn","send-fn",351002041));
var state_31056 = cljs.core.get.call(null,map__31047_31052__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
nesferado.client.chsk = chsk_31053;

nesferado.client.ch_chsk = ch_recv_31054;

nesferado.client.chsk_send_BANG_ = send_fn_31055;

nesferado.client.chsk_state = state_31056;
 ...
 */
nesferado.client.event_msg_handler = (function nesferado$client$event_msg_handler(p__31057){
...
var ev_msg = map__31060__$1;
var id = cljs.core.get.call(null,map__31060__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var _QMARK_data = cljs.core.get.call(null,map__31060__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var event = cljs.core.get.call(null,map__31060__$1,new cljs.core.Keyword(null,"event","event",301435442));
return nesferado.client._event_msg_handler.call(null,ev_msg);
});
cljs.core._add_method.call(null,nesferado.client._event_msg_handler,new cljs.core.Keyword(null,"default","default",-1987822328),(function (p__31062){
...
var ev_msg = map__31063__$1;
var event = cljs.core.get.call(null,map__31063__$1,new cljs.core.Keyword(null,"event","event",301435442));
return console.log(".NF. unhandled:",event);
}));
cljs.core._add_method.call(null,nesferado.client._event_msg_handler,new cljs.core.Keyword("chsk","state","chsk/state",-1991397620),(function (p__31065){
...
var ev_msg = map__31066__$1;
var _QMARK_data = cljs.core.get.call(null,map__31066__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var vec__31068 = (function (){var e = (function (){try{if(cljs.core.vector_QMARK_.call(null,_QMARK_data)){
return null;
} else {
...
var old_state_map = cljs.core.nth.call(null,vec__31068,(0),null);
var new_state_map = cljs.core.nth.call(null,vec__31068,(1),null);
...
cljs.core._add_method.call(null,nesferado.client._event_msg_handler,new cljs.core.Keyword("chsk","recv","chsk/recv",561097091),(function (p__31072){
...
var ev_msg = map__31073__$1;
var _QMARK_data = cljs.core.get.call(null,map__31073__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
return console.log(".NF. push from serv: ",_QMARK_data);
}));
cljs.core._add_method.call(null,nesferado.client._event_msg_handler,new cljs.core.Keyword("chsk","handshake","chsk/handshake",64910686),(function (p__31075){
...
var ev_msg = map__31076__$1;
var _QMARK_data = cljs.core.get.call(null,map__31076__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var vec__31078 = _QMARK_data;
var _QMARK_uid = cljs.core.nth.call(null,vec__31078,(0),null);
var _QMARK_csrf_token = cljs.core.nth.call(null,vec__31078,(1),null);
var _QMARK_handshake_data = cljs.core.nth.call(null,vec__31078,(2),null);
...
var temp__4657__auto___31081 = document.getElementById("btn1");
if(cljs.core.truth_(temp__4657__auto___31081)){
var target_el_31082 = temp__4657__auto___31081;
target_el_31082.addEventListener("click",((function (target_el_31082,temp__4657__auto___31081){
return (function (ev){
...
});})(target_el_31082,temp__4657__auto___31081))
);
} else {
}
var temp__4657__auto___31083 = document.getElementById("btn2");
if(cljs.core.truth_(temp__4657__auto___31083)){
var target_el_31084 = temp__4657__auto___31083;
target_el_31084.addEventListener("click",((function (target_el_31084,temp__4657__auto___31083){
return (function (ev){
nesferado.client.__GT_output_BANG_.call(null,"Button 2 was clicked (will receive reply from server)");

return nesferado.client.chsk_send_BANG_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("example","button2","example/button2",-675598425),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"had-a-callback?","had-a-callback?",-512946762),"indeed"], null)], null),(5000),((function (target_el_31084,temp__4657__auto___31083){
return (function (cb_reply){
return nesferado.client.__GT_output_BANG_.call(null,"Callback reply: %s",cb_reply);
});})(target_el_31084,temp__4657__auto___31083))
);
});})(target_el_31084,temp__4657__auto___31083))
);
} else {
}
var temp__4657__auto___31085 = document.getElementById("btn3");
if(cljs.core.truth_(temp__4657__auto___31085)){
var target_el_31086 = temp__4657__auto___31085;
target_el_31086.addEventListener("click",((function (target_el_31086,temp__4657__auto___31085){
return (function (ev){
...
});})(target_el_31086,temp__4657__auto___31085))
);
} else {
}
var temp__4657__auto___31087 = document.getElementById("btn4");
if(cljs.core.truth_(temp__4657__auto___31087)){
var target_el_31088 = temp__4657__auto___31087;
target_el_31088.addEventListener("click",((function (target_el_31088,temp__4657__auto___31087){
return (function (ev){
nesferado.client.__GT_output_BANG_.call(null,"Button 4 was clicked (will toggle async broadcast loop)");

return nesferado.client.chsk_send_BANG_.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("example","toggle-broadcast","example/toggle-broadcast",-1640005413)], null),(5000),((function (target_el_31088,temp__4657__auto___31087){
return (function (cb_reply){
...
});})(target_el_31088,temp__4657__auto___31087))
);
});})(target_el_31088,temp__4657__auto___31087))
);
} else {
}
var temp__4657__auto___31089 = document.getElementById("btn5");
if(cljs.core.truth_(temp__4657__auto___31089)){
var target_el_31090 = temp__4657__auto___31089;
target_el_31090.addEventListener("click",((function (target_el_31090,temp__4657__auto___31089){
return (function (ev){
...
});})(target_el_31090,temp__4657__auto___31089))
);
} else {
}
var temp__4657__auto___31091 = document.getElementById("btn6");
if(cljs.core.truth_(temp__4657__auto___31091)){
var target_el_31092 = temp__4657__auto___31091;
target_el_31092.addEventListener("click",((function (target_el_31092,temp__4657__auto___31091){
return (function (ev){
...
});})(target_el_31092,temp__4657__auto___31091))
);
} else {
}
...
var post = cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__31093_SHARP_){
return cljs.core._EQ_.call(null,post_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__31093_SHARP_));
}),cljs.core.deref.call(null,nesferado.client.posts)));
return post;
});
nesferado.client.get_post_by_id.call(null,(77));
cljs.core.first.call(null,cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__31094_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(cljs.core.second.call(null,p1__31094_SHARP_)),(88));
...
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(cljs.core.second.call(null,p1__31095_SHARP_)),sort_me_id);
});})(sort_me_id))
,cljs.core.map_indexed.call(null,cljs.core.vector,cljs.core.deref.call(null,nesferado.client.posts)))));
...
var cids = new cljs.core.Keyword(null,"comments","comments",-293346423).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__31096_SHARP_){
return cljs.core._EQ_.call(null,post_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__31096_SHARP_));
}),cljs.core.deref.call(null,nesferado.client.posts))));
...
return (new cljs.core.Keyword(null,"ratings-total","ratings-total",1788444318).cljs$core$IFn$_invoke$arity$1(p1__31097_SHARP_) / new cljs.core.Keyword(null,"number-of-ratings","number-of-ratings",-130471128).cljs$core$IFn$_invoke$arity$1(p1__31097_SHARP_));
});})(cids,posts))
,posts);
...
cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__31098_SHARP_){
return cljs.core._EQ_.call(null,(69),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__31098_SHARP_));
}),cljs.core.deref.call(null,nesferado.client.posts)));
...
var success_QMARK_ = cljs.core.get.call(null,map__31101__$1,new cljs.core.Keyword(null,"success?","success?",-122854052));
var _QMARK_status = cljs.core.get.call(null,map__31101__$1,new cljs.core.Keyword(null,"?status","?status",938730360));
var _QMARK_error = cljs.core.get.call(null,map__31101__$1,new cljs.core.Keyword(null,"?error","?error",1070752222));
var _QMARK_content = cljs.core.get.call(null,map__31101__$1,new cljs.core.Keyword(null,"?content","?content",1697782054));
var _QMARK_content_type = cljs.core.get.call(null,map__31101__$1,new cljs.core.Keyword(null,"?content-type","?content-type",-2129759049));
...
var comp_31103 = new cljs.core.Keyword("rum","react-component","rum/react-component",-1879897248).cljs$core$IFn$_invoke$arity$1(state);
var dom_node_31104 = ReactDOM.findDOMNode(comp_31103);
dom_node_31104.classList = "justMounted";
...
return cljs.core._EQ_.call(null,pid,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__31105_SHARP_));
...
return cljs.core._EQ_.call(null,p1__31106_SHARP_,pid);
});})(noc_post,post_coll,input_coll,cids,local_atom))
,cljs.core.get_in.call(null,cljs.core.deref.call(null,nesferado.client.input_state),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"inputs","inputs",865803858),(0),new cljs.core.Keyword(null,"selected-child","selected-child",-1028326940)], null))))?"selectedChild":null))], null))}),sablono.interpreter.interpret.call(null,new cljs.core.Keyword(null,"contents","contents",-1567174023).cljs$core$IFn$_invoke$arity$1(noc_post)),(function (){var attrs31111 = new cljs.core.Keyword(null,"author","author",2111686192).cljs$core$IFn$_invoke$arity$1(noc_post);
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs31111))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["item-author"], null)], null),attrs31111)):({"className": "item-author"})),((cljs.core.map_QMARK_.call(null,attrs31111))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31111)], null)));
...
, "className": "item-rate-minus"}),"-"),(function (){var attrs31112 = (new cljs.core.Keyword(null,"ratings-total","ratings-total",1788444318).cljs$core$IFn$_invoke$arity$1(noc_post) / new cljs.core.Keyword(null,"number-of-ratings","number-of-ratings",-130471128).cljs$core$IFn$_invoke$arity$1(noc_post));
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs31112))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["item-rating"], null)], null),attrs31112)):({"className": "item-rating"})),((cljs.core.map_QMARK_.call(null,attrs31112))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31112)], null)));
})()))));
} else {
...
return cljs.core._EQ_.call(null,pid,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__31107_SHARP_));
});})(post_coll,input_coll,cids,local_atom))
,cljs.core.sort_by.call(null,((function (post_coll,input_coll,cids,local_atom){
return (function (p1__31108_SHARP_){
return (new cljs.core.Keyword(null,"ratings-total","ratings-total",1788444318).cljs$core$IFn$_invoke$arity$1(p1__31108_SHARP_) / new cljs.core.Keyword(null,"number-of-ratings","number-of-ratings",-130471128).cljs$core$IFn$_invoke$arity$1(p1__31108_SHARP_));
});})(post_coll,input_coll,cids,local_atom))
,post_coll)));
...
return cljs.core._EQ_.call(null,p1__31109_SHARP_,pid);
});})(com_post,post_coll,input_coll,cids,local_atom))
,cljs.core.get_in.call(null,cljs.core.deref.call(null,nesferado.client.input_state),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"inputs","inputs",865803858),(0),new cljs.core.Keyword(null,"selected-child","selected-child",-1028326940)], null))))?"selectedChild":null))], null))}),sablono.interpreter.interpret.call(null,new cljs.core.Keyword(null,"contents","contents",-1567174023).cljs$core$IFn$_invoke$arity$1(com_post)),(function (){var attrs31113 = new cljs.core.Keyword(null,"author","author",2111686192).cljs$core$IFn$_invoke$arity$1(com_post);
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs31113))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["item-author"], null)], null),attrs31113)):({"className": "item-author"})),((cljs.core.map_QMARK_.call(null,attrs31113))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31113)], null)));
...
, "className": "item-rate-minus"}),"-"),(function (){var attrs31114 = (new cljs.core.Keyword(null,"ratings-total","ratings-total",1788444318).cljs$core$IFn$_invoke$arity$1(com_post) / new cljs.core.Keyword(null,"number-of-ratings","number-of-ratings",-130471128).cljs$core$IFn$_invoke$arity$1(com_post));
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs31114))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["item-rating"], null)], null),attrs31114)):({"className": "item-rating"})),((cljs.core.map_QMARK_.call(null,attrs31114))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31114)], null)));
...
var attrs31115 = nesferado.client.create_account_fields.call(null);
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs31115))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"create-account-contain"], null),attrs31115)):({"id": "create-account-contain"})),((cljs.core.map_QMARK_.call(null,attrs31115))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31115)], null)));
...
return React.createElement("div",({"id": "sidebar"}),React.createElement("ol",({"className": "sidebar"}),(function (){var attrs31118 = nesferado.client.link.call(null,"edit profile");
return cljs.core.apply.call(null,React.createElement,"li",((cljs.core.map_QMARK_.call(null,attrs31118))?sablono.interpreter.attributes.call(null,attrs31118):null),((cljs.core.map_QMARK_.call(null,attrs31118))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31118)], null)));
})(),(function (){var attrs31119 = nesferado.client.link.call(null,"view profile");
return cljs.core.apply.call(null,React.createElement,"li",((cljs.core.map_QMARK_.call(null,attrs31119))?sablono.interpreter.attributes.call(null,attrs31119):null),((cljs.core.map_QMARK_.call(null,attrs31119))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31119)], null)));
})(),(function (){var attrs31120 = nesferado.client.link.call(null,"stats");
return cljs.core.apply.call(null,React.createElement,"li",((cljs.core.map_QMARK_.call(null,attrs31120))?sablono.interpreter.attributes.call(null,attrs31120):null),((cljs.core.map_QMARK_.call(null,attrs31120))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31120)], null)));
})(),(function (){var attrs31121 = nesferado.client.link.call(null,"set password");
return cljs.core.apply.call(null,React.createElement,"li",((cljs.core.map_QMARK_.call(null,attrs31121))?sablono.interpreter.attributes.call(null,attrs31121):null),((cljs.core.map_QMARK_.call(null,attrs31121))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31121)], null)));
})(),(function (){var attrs31122 = nesferado.client.link.call(null,"set email");
return cljs.core.apply.call(null,React.createElement,"li",((cljs.core.map_QMARK_.call(null,attrs31122))?sablono.interpreter.attributes.call(null,attrs31122):null),((cljs.core.map_QMARK_.call(null,attrs31122))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31122)], null)));
})(),(function (){var attrs31123 = nesferado.client.link.call(null,"invite friends");
return cljs.core.apply.call(null,React.createElement,"li",((cljs.core.map_QMARK_.call(null,attrs31123))?sablono.interpreter.attributes.call(null,attrs31123):null),((cljs.core.map_QMARK_.call(null,attrs31123))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31123)], null)));
})(),(function (){var attrs31124 = nesferado.client.link.call(null,"give feedback");
return cljs.core.apply.call(null,React.createElement,"li",((cljs.core.map_QMARK_.call(null,attrs31124))?sablono.interpreter.attributes.call(null,attrs31124):null),((cljs.core.map_QMARK_.call(null,attrs31124))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31124)], null)));
})(),(function (){var attrs31125 = nesferado.client.link.call(null,"$upport nonforum");
return cljs.core.apply.call(null,React.createElement,"li",((cljs.core.map_QMARK_.call(null,attrs31125))?sablono.interpreter.attributes.call(null,attrs31125):null),((cljs.core.map_QMARK_.call(null,attrs31125))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31125)], null)));
})()));
}),null,"side-bar");
...
, "id": [cljs.core.str("tile"),cljs.core.str(id)].join(''), "className": "tile"}),(function (){var attrs31126 = title;
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs31126))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["heading"], null)], null),attrs31126)):({"className": "heading"})),((cljs.core.map_QMARK_.call(null,attrs31126))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31126)], null)));
})(),(function (){var attrs31127 = contents;
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs31127))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["contents"], null)], null),attrs31127)):({"className": "contents"})),((cljs.core.map_QMARK_.call(null,attrs31127))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31127)], null)));
})(),(function (){var attrs31128 = id;
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs31128))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["priority"], null)], null),attrs31128)):({"className": "priority"})),((cljs.core.map_QMARK_.call(null,attrs31128))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31128)], null)));
})()));
} else {
return null;
}
...
return React.createElement("div",({"id": "tv"}),(function (){var attrs31129 = cljs.core.map.call(null,nesferado.client.tv_cell,new cljs.core.Keyword(null,"tiles","tiles",178505240).cljs$core$IFn$_invoke$arity$1(rum.core.react.call(null,nesferado.client.tv_state)));
return cljs.core.apply.call(null,React.createElement,"ol",((cljs.core.map_QMARK_.call(null,attrs31129))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["tv"], null)], null),attrs31129)):({"className": "tv"})),((cljs.core.map_QMARK_.call(null,attrs31129))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31129)], null)));
})());
...
var first_hit_31132 = cljs.core.first.call(null,cljs.core.keep_indexed.call(null,((function (parent_id,username,new_comment_map){
return (function (p1__31131_SHARP_,p2__31130_SHARP_){
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p2__31130_SHARP_),parent_id)){
...
,cljs.core.deref.call(null,nesferado.client.posts)));
console.log(">< ",cljs.core.get_in.call(null,cljs.core.deref.call(null,nesferado.client.posts),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [first_hit_31132,new cljs.core.Keyword(null,"comments","comments",-293346423)], null)),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new_comment_map));

cljs.core.swap_BANG_.call(null,nesferado.client.posts,cljs.core.conj,new_comment_map);

cljs.core.swap_BANG_.call(null,nesferado.client.posts,cljs.core.update_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [first_hit_31132,new cljs.core.Keyword(null,"comments","comments",-293346423)], null),cljs.core.conj,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new_comment_map));
...
var attrs31137 = nesferado.client.post_comment_input.call(null);
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs31137))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"inputs-contain"], null),attrs31137)):({"id": "inputs-contain"})),((cljs.core.map_QMARK_.call(null,attrs31137))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs31137)], null)));
}),null,"input-fields");
...
var temp__4657__auto___31143 = document.getElementById("crsubmit");
if(cljs.core.truth_(temp__4657__auto___31143)){
var target_el_31144 = temp__4657__auto___31143;
target_el_31144.addEventListener("click",((function (target_el_31144,temp__4657__auto___31143){
return (function (ev){
...
var success_QMARK_ = cljs.core.get.call(null,map__31141__$1,new cljs.core.Keyword(null,"success?","success?",-122854052));
var _QMARK_status = cljs.core.get.call(null,map__31141__$1,new cljs.core.Keyword(null,"?status","?status",938730360));
var _QMARK_error = cljs.core.get.call(null,map__31141__$1,new cljs.core.Keyword(null,"?error","?error",1070752222));
var _QMARK_content = cljs.core.get.call(null,map__31141__$1,new cljs.core.Keyword(null,"?content","?content",1697782054));
var _QMARK_content_type = cljs.core.get.call(null,map__31141__$1,new cljs.core.Keyword(null,"?content-type","?content-type",-2129759049));
...
});})(user_id,pw,pw2,target_el_31144,temp__4657__auto___31143))
);
}
});})(target_el_31144,temp__4657__auto___31143))
);
} else {
}
