...
var len__9668__auto___23767 = arguments.length;
var i__9669__auto___23768 = (0);
while(true){
if((i__9669__auto___23768 < len__9668__auto___23767)){
args__9675__auto__.push((arguments[i__9669__auto___23768]));

var G__23769 = (i__9669__auto___23768 + (1));
i__9669__auto___23768 = G__23769;
continue;
} else {
}
break;
...
nesferado.client.__GT_output_BANG_.cljs$lang$applyTo = (function (seq23765){
var G__23766 = cljs.core.first.call(null,seq23765);
var seq23765__$1 = cljs.core.next.call(null,seq23765);
return nesferado.client.__GT_output_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__23766,seq23765__$1);
});

nesferado.client.__GT_output_BANG_.call(null," \u2022 Welcome to Nonforum \u2022");
var rand_chsk_type_23772 = (((cljs.core.rand.call(null) >= 0.5))?new cljs.core.Keyword(null,"ajax","ajax",814345549):new cljs.core.Keyword(null,"auto","auto",-566279492));
var packer_23773 = new cljs.core.Keyword(null,"edn","edn",1317840885);
var map__23770_23774 = taoensso.sente.make_channel_socket_client_BANG_.call(null,"/chsk",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),rand_chsk_type_23772,new cljs.core.Keyword(null,"packer","packer",66077544),packer_23773], null));
var map__23770_23775__$1 = ((((!((map__23770_23774 == null)))?((((map__23770_23774.cljs$lang$protocol_mask$partition0$ & (64))) || (map__23770_23774.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23770_23774):map__23770_23774);
var chsk_23776 = cljs.core.get.call(null,map__23770_23775__$1,new cljs.core.Keyword(null,"chsk","chsk",-863703081));
var ch_recv_23777 = cljs.core.get.call(null,map__23770_23775__$1,new cljs.core.Keyword(null,"ch-recv","ch-recv",-990916861));
var send_fn_23778 = cljs.core.get.call(null,map__23770_23775__$1,new cljs.core.Keyword(null,"send-fn","send-fn",351002041));
var state_23779 = cljs.core.get.call(null,map__23770_23775__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
nesferado.client.chsk = chsk_23776;

nesferado.client.ch_chsk = ch_recv_23777;

nesferado.client.chsk_send_BANG_ = send_fn_23778;

nesferado.client.chsk_state = state_23779;
 ...
 */
nesferado.client.event_msg_handler = (function nesferado$client$event_msg_handler(p__23780){
...
var ev_msg = map__23783__$1;
var id = cljs.core.get.call(null,map__23783__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var _QMARK_data = cljs.core.get.call(null,map__23783__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var event = cljs.core.get.call(null,map__23783__$1,new cljs.core.Keyword(null,"event","event",301435442));
return nesferado.client._event_msg_handler.call(null,ev_msg);
});
cljs.core._add_method.call(null,nesferado.client._event_msg_handler,new cljs.core.Keyword(null,"default","default",-1987822328),(function (p__23785){
...
var ev_msg = map__23786__$1;
var event = cljs.core.get.call(null,map__23786__$1,new cljs.core.Keyword(null,"event","event",301435442));
return console.log(".NF. unhandled:",event);
}));
cljs.core._add_method.call(null,nesferado.client._event_msg_handler,new cljs.core.Keyword("chsk","state","chsk/state",-1991397620),(function (p__23788){
...
var vec__23791 = (function (){var e = (function (){try{if(cljs.core.vector_QMARK_.call(null,_QMARK_data)){
return null;
} else {
...
var old_state_map = cljs.core.nth.call(null,vec__23791,(0),null);
var new_state_map = cljs.core.nth.call(null,vec__23791,(1),null);
...
cljs.core._add_method.call(null,nesferado.client._event_msg_handler,new cljs.core.Keyword("chsk","recv","chsk/recv",561097091),(function (p__23795){
...
var ev_msg = map__23796__$1;
var _QMARK_data = cljs.core.get.call(null,map__23796__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
return console.log(".NF. push from serv: ",_QMARK_data);
}));
cljs.core._add_method.call(null,nesferado.client._event_msg_handler,new cljs.core.Keyword("chsk","handshake","chsk/handshake",64910686),(function (p__23798){
...
var ev_msg = map__23799__$1;
var _QMARK_data = cljs.core.get.call(null,map__23799__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var vec__23801 = _QMARK_data;
var _QMARK_uid = cljs.core.nth.call(null,vec__23801,(0),null);
var _QMARK_csrf_token = cljs.core.nth.call(null,vec__23801,(1),null);
var _QMARK_handshake_data = cljs.core.nth.call(null,vec__23801,(2),null);
...
var temp__4657__auto___23804 = document.getElementById("btn1");
if(cljs.core.truth_(temp__4657__auto___23804)){
var target_el_23805 = temp__4657__auto___23804;
target_el_23805.addEventListener("click",((function (target_el_23805,temp__4657__auto___23804){
return (function (ev){
...
});})(target_el_23805,temp__4657__auto___23804))
);
} else {
}
var temp__4657__auto___23806 = document.getElementById("btn2");
if(cljs.core.truth_(temp__4657__auto___23806)){
var target_el_23807 = temp__4657__auto___23806;
target_el_23807.addEventListener("click",((function (target_el_23807,temp__4657__auto___23806){
return (function (ev){
nesferado.client.__GT_output_BANG_.call(null,"Button 2 was clicked (will receive reply from server)");

return nesferado.client.chsk_send_BANG_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("example","button2","example/button2",-675598425),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"had-a-callback?","had-a-callback?",-512946762),"indeed"], null)], null),(5000),((function (target_el_23807,temp__4657__auto___23806){
return (function (cb_reply){
return nesferado.client.__GT_output_BANG_.call(null,"Callback reply: %s",cb_reply);
});})(target_el_23807,temp__4657__auto___23806))
);
});})(target_el_23807,temp__4657__auto___23806))
);
} else {
}
var temp__4657__auto___23808 = document.getElementById("btn3");
if(cljs.core.truth_(temp__4657__auto___23808)){
var target_el_23809 = temp__4657__auto___23808;
target_el_23809.addEventListener("click",((function (target_el_23809,temp__4657__auto___23808){
return (function (ev){
...
});})(target_el_23809,temp__4657__auto___23808))
);
} else {
}
var temp__4657__auto___23810 = document.getElementById("btn4");
if(cljs.core.truth_(temp__4657__auto___23810)){
var target_el_23811 = temp__4657__auto___23810;
target_el_23811.addEventListener("click",((function (target_el_23811,temp__4657__auto___23810){
return (function (ev){
nesferado.client.__GT_output_BANG_.call(null,"Button 4 was clicked (will toggle async broadcast loop)");

return nesferado.client.chsk_send_BANG_.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("example","toggle-broadcast","example/toggle-broadcast",-1640005413)], null),(5000),((function (target_el_23811,temp__4657__auto___23810){
return (function (cb_reply){
...
});})(target_el_23811,temp__4657__auto___23810))
);
});})(target_el_23811,temp__4657__auto___23810))
);
} else {
}
var temp__4657__auto___23812 = document.getElementById("btn5");
if(cljs.core.truth_(temp__4657__auto___23812)){
var target_el_23813 = temp__4657__auto___23812;
target_el_23813.addEventListener("click",((function (target_el_23813,temp__4657__auto___23812){
return (function (ev){
...
});})(target_el_23813,temp__4657__auto___23812))
);
} else {
}
var temp__4657__auto___23814 = document.getElementById("btn6");
if(cljs.core.truth_(temp__4657__auto___23814)){
var target_el_23815 = temp__4657__auto___23814;
target_el_23815.addEventListener("click",((function (target_el_23815,temp__4657__auto___23814){
return (function (ev){
...
});})(target_el_23815,temp__4657__auto___23814))
);
} else {
}
...
var post = cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__23816_SHARP_){
return cljs.core._EQ_.call(null,post_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__23816_SHARP_));
}),cljs.core.deref.call(null,nesferado.client.posts)));
return post;
});
nesferado.client.get_post_by_id.call(null,(77));
cljs.core.first.call(null,cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__23817_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(cljs.core.second.call(null,p1__23817_SHARP_)),(88));
...
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(cljs.core.second.call(null,p1__23818_SHARP_)),sort_me_id);
});})(sort_me_id))
,cljs.core.map_indexed.call(null,cljs.core.vector,cljs.core.deref.call(null,nesferado.client.posts)))));
...
var cids = new cljs.core.Keyword(null,"comments","comments",-293346423).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__23819_SHARP_){
return cljs.core._EQ_.call(null,post_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__23819_SHARP_));
}),cljs.core.deref.call(null,nesferado.client.posts))));
...
return (new cljs.core.Keyword(null,"ratings-total","ratings-total",1788444318).cljs$core$IFn$_invoke$arity$1(p1__23820_SHARP_) / new cljs.core.Keyword(null,"number-of-ratings","number-of-ratings",-130471128).cljs$core$IFn$_invoke$arity$1(p1__23820_SHARP_));
});})(cids,posts))
,posts);
...
cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__23821_SHARP_){
return cljs.core._EQ_.call(null,(69),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__23821_SHARP_));
}),cljs.core.deref.call(null,nesferado.client.posts)));
...
var success_QMARK_ = cljs.core.get.call(null,map__23824__$1,new cljs.core.Keyword(null,"success?","success?",-122854052));
var _QMARK_status = cljs.core.get.call(null,map__23824__$1,new cljs.core.Keyword(null,"?status","?status",938730360));
var _QMARK_error = cljs.core.get.call(null,map__23824__$1,new cljs.core.Keyword(null,"?error","?error",1070752222));
var _QMARK_content = cljs.core.get.call(null,map__23824__$1,new cljs.core.Keyword(null,"?content","?content",1697782054));
var _QMARK_content_type = cljs.core.get.call(null,map__23824__$1,new cljs.core.Keyword(null,"?content-type","?content-type",-2129759049));
...
var comp_23826 = new cljs.core.Keyword("rum","react-component","rum/react-component",-1879897248).cljs$core$IFn$_invoke$arity$1(state);
var dom_node_23827 = ReactDOM.findDOMNode(comp_23826);
dom_node_23827.classList = "justMounted";
...
return cljs.core._EQ_.call(null,pid,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__23828_SHARP_));
...
return cljs.core._EQ_.call(null,p1__23829_SHARP_,pid);
});})(noc_post,post_coll,input_coll,cids,local_atom))
,cljs.core.get_in.call(null,cljs.core.deref.call(null,nesferado.client.input_state),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"inputs","inputs",865803858),(0),new cljs.core.Keyword(null,"selected-child","selected-child",-1028326940)], null))))?"selectedChild":null))], null))}),sablono.interpreter.interpret.call(null,new cljs.core.Keyword(null,"contents","contents",-1567174023).cljs$core$IFn$_invoke$arity$1(noc_post)),(function (){var attrs23834 = new cljs.core.Keyword(null,"author","author",2111686192).cljs$core$IFn$_invoke$arity$1(noc_post);
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs23834))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["item-author"], null)], null),attrs23834)):({"className": "item-author"})),((cljs.core.map_QMARK_.call(null,attrs23834))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs23834)], null)));
...
, "className": "item-rate-minus"}),"-"),(function (){var attrs23835 = (new cljs.core.Keyword(null,"ratings-total","ratings-total",1788444318).cljs$core$IFn$_invoke$arity$1(noc_post) / new cljs.core.Keyword(null,"number-of-ratings","number-of-ratings",-130471128).cljs$core$IFn$_invoke$arity$1(noc_post));
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs23835))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["item-rating"], null)], null),attrs23835)):({"className": "item-rating"})),((cljs.core.map_QMARK_.call(null,attrs23835))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs23835)], null)));
})()))));
} else {
...
return cljs.core._EQ_.call(null,pid,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__23830_SHARP_));
});})(post_coll,input_coll,cids,local_atom))
,cljs.core.sort_by.call(null,((function (post_coll,input_coll,cids,local_atom){
return (function (p1__23831_SHARP_){
return (new cljs.core.Keyword(null,"ratings-total","ratings-total",1788444318).cljs$core$IFn$_invoke$arity$1(p1__23831_SHARP_) / new cljs.core.Keyword(null,"number-of-ratings","number-of-ratings",-130471128).cljs$core$IFn$_invoke$arity$1(p1__23831_SHARP_));
});})(post_coll,input_coll,cids,local_atom))
,post_coll)));
...
return cljs.core._EQ_.call(null,p1__23832_SHARP_,pid);
});})(com_post,post_coll,input_coll,cids,local_atom))
,cljs.core.get_in.call(null,cljs.core.deref.call(null,nesferado.client.input_state),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"inputs","inputs",865803858),(0),new cljs.core.Keyword(null,"selected-child","selected-child",-1028326940)], null))))?"selectedChild":null))], null))}),sablono.interpreter.interpret.call(null,new cljs.core.Keyword(null,"contents","contents",-1567174023).cljs$core$IFn$_invoke$arity$1(com_post)),(function (){var attrs23836 = new cljs.core.Keyword(null,"author","author",2111686192).cljs$core$IFn$_invoke$arity$1(com_post);
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs23836))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["item-author"], null)], null),attrs23836)):({"className": "item-author"})),((cljs.core.map_QMARK_.call(null,attrs23836))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs23836)], null)));
...
, "className": "item-rate-minus"}),"-"),(function (){var attrs23837 = (new cljs.core.Keyword(null,"ratings-total","ratings-total",1788444318).cljs$core$IFn$_invoke$arity$1(com_post) / new cljs.core.Keyword(null,"number-of-ratings","number-of-ratings",-130471128).cljs$core$IFn$_invoke$arity$1(com_post));
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs23837))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["item-rating"], null)], null),attrs23837)):({"className": "item-rating"})),((cljs.core.map_QMARK_.call(null,attrs23837))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs23837)], null)));
...
var attrs23838 = nesferado.client.create_account_fields.call(null);
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs23838))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"create-account-contain"], null),attrs23838)):({"id": "create-account-contain"})),((cljs.core.map_QMARK_.call(null,attrs23838))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs23838)], null)));
...
}),"sidebar"))),(function (){var attrs23839 = nesferado.client.link.call(null,"top");
...
})(),(function (){var attrs23840 = nesferado.client.link.call(null,"submit");
...
})(),(function (){var attrs23841 = current_user;
...
return React.createElement("div",({"id": "sidebar"}),React.createElement("ol",({"className": "sidebar"}),(function (){var attrs23844 = nesferado.client.link.call(null,"profile");
return cljs.core.apply.call(null,React.createElement,"li",((cljs.core.map_QMARK_.call(null,attrs23844))?sablono.interpreter.attributes.call(null,attrs23844):null),((cljs.core.map_QMARK_.call(null,attrs23844))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs23844)], null)));
})(),(function (){var attrs23845 = nesferado.client.link.call(null,"settings & pls omg no moar hax");
return cljs.core.apply.call(null,React.createElement,"li",((cljs.core.map_QMARK_.call(null,attrs23845))?sablono.interpreter.attributes.call(null,attrs23845):null),((cljs.core.map_QMARK_.call(null,attrs23845))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs23845)], null)));
})(),(function (){var attrs23846 = nesferado.client.link.call(null,"feedback & hax");
return cljs.core.apply.call(null,React.createElement,"li",((cljs.core.map_QMARK_.call(null,attrs23846))?sablono.interpreter.attributes.call(null,attrs23846):null),((cljs.core.map_QMARK_.call(null,attrs23846))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs23846)], null)));
})(),(function (){var attrs23847 = nesferado.client.link.call(null,"logout");
return cljs.core.apply.call(null,React.createElement,"li",((cljs.core.map_QMARK_.call(null,attrs23847))?sablono.interpreter.attributes.call(null,attrs23847):null),((cljs.core.map_QMARK_.call(null,attrs23847))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs23847)], null)));
})()));
}),null,"side-bar");
...
, "id": [cljs.core.str("tile"),cljs.core.str(id)].join(''), "className": "tile"}),(function (){var attrs23848 = title;
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs23848))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["heading"], null)], null),attrs23848)):({"className": "heading"})),((cljs.core.map_QMARK_.call(null,attrs23848))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs23848)], null)));
})(),(function (){var attrs23849 = contents;
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs23849))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["contents"], null)], null),attrs23849)):({"className": "contents"})),((cljs.core.map_QMARK_.call(null,attrs23849))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs23849)], null)));
})(),(function (){var attrs23850 = id;
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs23850))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["priority"], null)], null),attrs23850)):({"className": "priority"})),((cljs.core.map_QMARK_.call(null,attrs23850))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs23850)], null)));
})()));
}),null,"tv-cell");
nesferado.client.television = rum.core.build_defc.call(null,(function (){
return React.createElement("div",({"id": "tv"}),(function (){var attrs23851 = cljs.core.map.call(null,nesferado.client.tv_cell,new cljs.core.Keyword(null,"tiles","tiles",178505240).cljs$core$IFn$_invoke$arity$1(rum.core.react.call(null,nesferado.client.tv_state)));
return cljs.core.apply.call(null,React.createElement,"ol",((cljs.core.map_QMARK_.call(null,attrs23851))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["tv"], null)], null),attrs23851)):({"className": "tv"})),((cljs.core.map_QMARK_.call(null,attrs23851))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs23851)], null)));
})());
...
var first_hit_23854 = cljs.core.first.call(null,cljs.core.keep_indexed.call(null,((function (parent_id,username,new_comment_map){
return (function (p1__23853_SHARP_,p2__23852_SHARP_){
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p2__23852_SHARP_),parent_id)){
return p1__23853_SHARP_;
} else {
return null;
}
});})(parent_id,username,new_comment_map))
,cljs.core.deref.call(null,nesferado.client.posts)));
console.log(">< ",cljs.core.get_in.call(null,cljs.core.deref.call(null,nesferado.client.posts),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [first_hit_23854,new cljs.core.Keyword(null,"comments","comments",-293346423)], null)),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new_comment_map));

cljs.core.swap_BANG_.call(null,nesferado.client.posts,cljs.core.conj,new_comment_map);

cljs.core.swap_BANG_.call(null,nesferado.client.posts,cljs.core.update_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [first_hit_23854,new cljs.core.Keyword(null,"comments","comments",-293346423)], null),cljs.core.conj,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new_comment_map));
...
var attrs23859 = nesferado.client.post_comment_input.call(null);
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs23859))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"inputs-contain"], null),attrs23859)):({"id": "inputs-contain"})),((cljs.core.map_QMARK_.call(null,attrs23859))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs23859)], null)));
}),null,"input-fields");
...
var temp__4657__auto___23863 = document.getElementById("crsubmit");
if(cljs.core.truth_(temp__4657__auto___23863)){
var target_el_23864 = temp__4657__auto___23863;
target_el_23864.addEventListener("click",((function (target_el_23864,temp__4657__auto___23863){
return (function (ev){
...
var success_QMARK_ = cljs.core.get.call(null,map__23861__$1,new cljs.core.Keyword(null,"success?","success?",-122854052));
var _QMARK_status = cljs.core.get.call(null,map__23861__$1,new cljs.core.Keyword(null,"?status","?status",938730360));
var _QMARK_error = cljs.core.get.call(null,map__23861__$1,new cljs.core.Keyword(null,"?error","?error",1070752222));
var _QMARK_content = cljs.core.get.call(null,map__23861__$1,new cljs.core.Keyword(null,"?content","?content",1697782054));
var _QMARK_content_type = cljs.core.get.call(null,map__23861__$1,new cljs.core.Keyword(null,"?content-type","?content-type",-2129759049));
...
});})(user_id,pw,pw2,target_el_23864,temp__4657__auto___23863))
);
}
});})(target_el_23864,temp__4657__auto___23863))
);
} else {
}
