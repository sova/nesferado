...
var m__9257__auto__ = (alandipert.storage_atom._get[goog.typeOf(x__9256__auto__)]);
if(!((m__9257__auto__ == null))){
return m__9257__auto__.call(null,this$,not_found);
} else {
var m__9257__auto____$1 = (alandipert.storage_atom._get["_"]);
if(!((m__9257__auto____$1 == null))){
return m__9257__auto____$1.call(null,this$,not_found);
} else {
...
var x__9256__auto__ = (((this$ == null))?null:this$);
var m__9257__auto__ = (alandipert.storage_atom._commit_BANG_[goog.typeOf(x__9256__auto__)]);
if(!((m__9257__auto__ == null))){
return m__9257__auto__.call(null,this$,value);
} else {
var m__9257__auto____$1 = (alandipert.storage_atom._commit_BANG_["_"]);
if(!((m__9257__auto____$1 == null))){
return m__9257__auto____$1.call(null,this$,value);
} else {
...
var self__ = this;
var this$__$1 = this;
var temp__4655__auto__ = self__.store.getItem(tailrecursion.cljson.clj__GT_cljson.call(null,self__.key));
...
alandipert.storage_atom.StorageBackend.cljs$lang$ctorPrWriter = (function (this__9199__auto__,writer__9200__auto__,opt__9201__auto__){
return cljs.core._write.call(null,writer__9200__auto__,"alandipert.storage-atom/StorageBackend");
});
...
var G__31348 = atom;
cljs.core.add_watch.call(null,G__31348,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__31348,existing,debounce){
return (function (p1__31345_SHARP_,p2__31346_SHARP_,p3__31343_SHARP_,p4__31344_SHARP_){
if(cljs.core.truth_((function (){var and__8581__auto__ = alandipert.storage_atom._STAR_watch_active_STAR_;
if(cljs.core.truth_(and__8581__auto__)){
return cljs.core.not_EQ_.call(null,p3__31343_SHARP_,p4__31344_SHARP_);
} else {
return and__8581__auto__;
}
})())){
return debounce.call(null,((function (G__31348,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__31344_SHARP_);
});})(G__31348,existing,debounce))
,(function (){var or__8593__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
...
var _STAR_watch_active_STAR_31351 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_.call(null,atom,default$);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_31351;
}} else {
var temp__4657__auto__ = tailrecursion.cljson.cljson__GT_clj.call(null,e.key);
if(cljs.core.truth_(temp__4657__auto__)){
var sk = temp__4657__auto__;
if(cljs.core._EQ_.call(null,sk,k)){
var _STAR_watch_active_STAR_31352 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_.call(null,atom,(function (){var temp__4655__auto__ = e.newValue;
if(cljs.core.truth_(temp__4655__auto__)){
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_31352;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend.call(null,atom,storage,k,default$,p1__31353_SHARP_);
});})(default$))
);
});
/**
